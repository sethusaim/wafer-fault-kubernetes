...
class S3Operation:
    ...
    def read_object(self, object, decode=True, make_readable=False):
        ...
        """
        self.log_writer.info("Entered read_object method S3Operation class")
    ...
    def delete_file(self, fname, bucket):
        ...
        try:
            ...
            self.log_writer.info("Exited delete_file method of S3Operation")
    ...
    def upload_df_as_csv(
        self, data_frame, local_fname, bucket_fname, bucket,
    ):
        """

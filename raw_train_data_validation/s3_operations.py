...
class S3_Operation:
    ...
    def read_text(self, fname: str, bucket: str, log_file: str):
        """
    ...
    def read_json(self, fname: str, bucket: str, log_file: str):
        """
    ...
    def move_data(
        ...
        try:
            ...
            self.delete_file(from_bucket, from_fname, log_file)

            self.log_writer.log(
                f"Moved {from_fname} from bucket {from_bucket} to {to_bucket}", log_file
            )

...
class Main_Utils:
    ...
    def upload_logs(self):
        ...
        try:
            ...
            self.log_writer.log("Uploaded logs to logs s3 bucket", "upload")
    ...
    def create_dirs_for_good_bad_data(self, log_file):
        ...
        try:
            self.s3.create_folder("pred_good_data", "pred_data", log_file)

            self.s3.create_folder("pred_bad_data", "pred_data", log_file)

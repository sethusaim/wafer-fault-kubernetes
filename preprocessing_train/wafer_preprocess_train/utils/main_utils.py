...
class MainUtils:
    ...
    def upload_data_to_feature_store(self, data, key):
        ...
        """
        self.log_writer.info("Entered upload_data_to_feature_store method of S3Operation class")
        ...
        try:
            ...
            self.log_writer.info("Exited upload_data_to_feature_store method of S3Operation class")
    ...
    def upload_null_values_file(self, data):
        ...
        self.log_writer.info("Entered upload_null_values_file method of S3Operation class")
        ...
        try:
            ...
            self.log_writer.info("Exited upload_null_values_file method of S3Operation class")
    ...
    def get_file_with_timestamp(self, file):
        ...
        self.log_writer.info("Entered get_file_with_timestamp method of S3Operation class")
        ...
        try:
            ...
            self.log_writer.info("Exited get_file_with_timestamp method of S3Operation class")
